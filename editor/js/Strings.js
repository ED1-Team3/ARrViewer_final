function Strings( config ) {
	...
	var values = {
		...
		en: {
			...
			//Database strings were added
			'sidebar/database': 'Database',
			'sidebar/database/library': 'Library',
			...
			//new
			'sidebar/settings/viewport/darkmode': 'Dark Mode',
			...
			'toolbar/local': 'Local',
			//new
			'toolbar/perspectiveview': 'Perspective View',
			'toolbar/frontview': 'Front View',
			'toolbar/topview': 'Top View',
			'toolbar/sideview': 'Side View',
